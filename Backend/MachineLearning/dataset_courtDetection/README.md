# dataset_courtDetection

Training data for the **court-keypoint model** used by
[`CourtDetection/court.py`](../../CourtDetection/court.py)
(loads `CourtDetection/court_keypoints.pt`).
...
- Trained by `mainTrainingModels.py`'s `court_keypoint_datasets()` /
  ...
  [`CourtDetection/keypoints/training/train.py`](../../CourtDetection/keypoints/training/train.py).
