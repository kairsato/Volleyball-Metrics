...
Usage (from Backend/Analysis/, so CourtDetection is importable as a
top-level package):
    python -m CourtDetection.keypoints.training.train \\
        --data MachineLearning/dataset_courtDetection/merged/data.yaml --epochs 100
