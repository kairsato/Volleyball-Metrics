...
the same ReID-based appearance matching the within-job "might be the same
person" candidate-match system already relies on, just applied across jobs
...
# PlayerDetection lives under Backend/Analysis/, a sibling of the API/
