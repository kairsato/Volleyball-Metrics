...
See individual model/dataset entries under [Datasets & credits](#datasets--credits) for their respective licenses (mostly CC BY 4.0, one CC-BY-NC-4.0 base model, YOLO under AGPL-3.0/commercial). Original code in this repository is not currently under a published open-source license.
