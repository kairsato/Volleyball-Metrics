...
// game page's layout is sized to fit the viewport, but sub-pixel rounding
...
export function GamePage({ onJobUpdated }: GamePageProps) {
  useHiddenScrollbar();
  ...
  return (
    <JobWorkspace
      ...
      onBackToDashboard={() => navigate("/games")}
    />
  );
}
